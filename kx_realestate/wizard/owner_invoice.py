...
class OwnerAccountCheck(models.TransientModel):
    _name = 'owner.account.check'

    analytic_account_id = fields.Many2many('account.analytic.account')
    comm_percent = fields.Float(string='Commission Percentage', default=90.0)
    ...
    expense_line_ids = fields.One2many('owner.expense', 'main_id')
