...
class DashboardService(models.AbstractModel):
    ...
    @api.model
    def get_dashboard_data(self, site=False, building=False, floor=False,):
    ...
    @api.model
    def get_dashboard_data2(self, date_from=False, date_to=False, site=False, building=False, floor=False,):        
