...
class Building(models.Model):
    ...
    block_id = fields.Many2one('re.block', string='Block', tracking=True, ondelete='cascade')
    ...
    site_id = fields.Many2one('re.site', string='Site', tracking=True, ondelete='cascade')
