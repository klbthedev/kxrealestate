...
class OwnershipHandoverChecklist(models.Model):
    ...
    contract_no = fields.Char( related="ownership_contract_id.name", store=True, )
    partner_id = fields.Many2one( related="ownership_contract_id.partner_id", store=True, )
    site_id = fields.Many2one( related="ownership_contract_id.site_id", store=True, )
    building_id = fields.Many2one( related="ownership_contract_id.building_id", store=True, )
    floor_id = fields.Many2one( related="ownership_contract_id.floor_id", store=True,)
    unit_id = fields.Many2one( related="ownership_contract_id.building_unit_id", store=True,)
