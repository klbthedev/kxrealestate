...
class ReportLatePaymentsCustomersRent(models.AbstractModel):
    _name = 'report.kx_realestate.report_late_payments_customers_rent'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report = self.env['ir.actions.report']._get_report_from_name(
            'kx_realestate.report_late_payments_customers_rent'
        )
        form = data['form']
        return {
            'doc_ids': self.ids,
