...
class Parser(models.AbstractModel):
    _name = 'report.kx_realestate.report_due_payments_customers'
    ...
    def _get_report_values(self, data=None):
        ...
        due_payment = self.env['ir.actions.report']._get_report_from_name('kx_realestate.report_due_payments_customers')
        return {
            'doc_ids': self.ids,
